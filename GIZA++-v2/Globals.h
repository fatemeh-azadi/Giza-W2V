...
extern bool Verbose, Log, Peg, Transfer, Transfer2to3, useDict, useWord2Vec ;
extern string Prefix, LogFilename, OPath, 
  SourceVocabFilename, TargetVocabFilename, CorpusFilename, TestCorpusFilename, 
  t_Filename, a_Filename, p0_Filename, d_Filename, n_Filename, dictionary_Filename, sourceWord2Vec_Filename, targetWord2Vec_Filename;
